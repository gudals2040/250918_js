// 한 줄 주석 -> 무시
// ctrl + /
console.log("Hello World!"); // ctrl + s -> 저장 ;.formating
// node 01_syntax.js
// node 01 + tab키

// Console.log("Hello World!");
// ReferenceError: Console is not defined (대문자 불가)
...
// 중간에 스페이스를 섞으면 안됨.
// a f = 1
// 중간에 이게 합쳐진 단어라는 걸 알려주고 싶으면 표기법을 쓰게 되넨ㄷ
// 자바스크립트에서는 2가지 표기법. camelCase. PascalCase
// camleCase : 맨앞에는소문자, 스페이스가 들어가는 곳은 대문자. hello world -> helloWorld
...
// kebak-case : 변수명에는 쓸수 X, javascript에서는 벼수명에 - 특수문자를 쓸 수 X.
// 변수명에서는 camleCase를 쓴다!!!! -> 코드 규약. 은근히 중요함.

console.log(a); // 변수에다가 담긴 값을 사용해줌.

// 프로젝트 파일명이나 폴더는 '경로'이기 때문에 카멜케이스나 파스칼로 표현하면 잘 안보여요
// 그네 스페이스를 섞으면 나중에 %20 등으로 인코딩 깨짐이나옴 -> _나 -로 하고, 웹에 직접적으로 노출된다면 -.
...
// 하지만 앞으로 여러분들이 var를 쓸 잃은 없었다고 전해진다... (왜)
...
var e; // 선언
var e; // 재선언 - 재선언을 해도 전혀 에러 없이 지니감. (그냥 무시함)
...
// - 선언은 되어있는데 아무 값도 안주었을 때도 undefined고...
